import {
  ...
  Button, Paper, Stack, List, Flex, Textarea, Box, TextInput, Select, MultiSelect, Modal,
} from "@mantine/core";
    ...
    <Container size={"lg"}>
      <Grid>
        <Grid.Col span={8}>
          ...
          <Grid mt={"md"}>
            <Grid.Col span={4}>
              <Button leftSection={addIcon} size={"sm"} variant={"subtle"} onClick={open}>Add File Group</Button>
            </Grid.Col>
            <Grid.Col span={8}>
              <Group>
                {
      ...
      <Modal opened={opened} onClose={close} title="Create a Group">
        <Stack m={"md"}>
            ...
            <MultiSelect withAsterisk label="Select Reviewers" data={prReviewers} value={reviewerList} onChange={setReviewerList} />

        </Stack>
        <Group justify={"flex-end"}>
          <Button color={"gray"} onClick={close}>Close</Button>
          <Link to={"/createPR"}>
            <Button variant="contained" onClick={addGroupToList}>Add</Button>
          </Link>
        </Group>
      </Modal>
    </Container>
