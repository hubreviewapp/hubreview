  ...
  const rows = users.map((element) => (
    <Table.Tr key={element.id}>
      ...
      <Table.Td>
        <Text color={"green"}>
          {
            calculatePercentage(element.approval ,element.rejection)
          } %
        </Text>
      </Table.Td>
      <Table.Td>
        <Text color={"red"}>
          {
            calculatePercentage(element.rejection ,element.approval)
          } %
        </Text>
      </Table.Td>
    </Table.Tr>
