          ...
          <Box p="md">
            <Text onClick={() => setCommentsVisible(!isCommentsVisible)}>
              <Group className={classes.resolved}>
                ...
                { isCommentsVisible ?
                <Text c="dimmed">Hide Resolved</Text> :
                <Text c="dimmed">Show Resolved</Text>
            }
              </Group>
            </Text>
            {
            ...
            <Box align="right">
              <Divider my="xs"/>
              <Button variant="light" onClick={() => setResolved(false)}>Unresolve Conversation</Button>
            </Box>
          </Box>
            ...
            <Box p="md">
              ...
              {replyActive ?
                ...
                <div>
                  <TextEditor content=""/>
                  <Box align="right">
                    <Button color="gray" mx="md" onClick={() => setReplyActive(false)}> Cancel </Button>
                    <Button> Reply </Button>
                  </Box>
                </div>
                :
              ...
              <Box align="right">
                <Divider my="xs"/>
                <Button variant="light" onClick={() => setResolved(true)}>Resolve Conversation</Button>
              </Box>
            </Box>
          </div>
        }
