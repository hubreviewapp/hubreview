...
function DiffComment() {
  return (
      <Paper withBorder radius="md" className={classes.comment} shadow="lg">
        ...
        <h5>This could be wrapped in a Boolean to make sure the type is a boolean instead of string. Isn't that in our latest style guideline, @ecekahraman?</h5>
        <div />
        ...
        <Group justify="start" mt={5}>
          ...
          <Text c="gray" size="sm">ecekahraman was requested to review this comment</Text>
        </Group>
      </Paper>
  )
}
