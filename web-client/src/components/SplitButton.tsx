      ...
      >
        ...
        <Popover.Dropdown style={{ width: 840}}>
          <Box style={{display: 'flex'}}>
            <Box>
            <IconX
              color="red" style= {{width: rem(30), height: rem(30), marginLeft: 5, marginTop: 10, }} />
            </Box>
          ...
          <Text size="sm">
            At least 3 approving review is required by reviewers with write access.
          </Text>
          ...
          <Box style={{display: 'flex'}}>
            <Box>
              <IconCheck
                color= "green" style={{ width: rem(30), height: rem(30), marginLeft: 5, marginTop: 10, }} />
            </Box>
          ...
          <Group wrap="nowrap" gap={0} style={{border: "1px groove gray", width:250}}>
            <Button disabled color="green" className={classes.button} >Merge Pull Request</Button>
