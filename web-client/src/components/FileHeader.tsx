...
function FileHeader({
  ...
  return (
    <Paper w="100%" h="100px">
      <Box my="sm">
        <Title order={3} mb="sm">{fileName}</Title>
        <Flex gap="md">
          <Text c="dimmed">Last updated on {lastUpdate.toDateString()} by {}
            <UnstyledButton c="blue">{author}</UnstyledButton></Text>
