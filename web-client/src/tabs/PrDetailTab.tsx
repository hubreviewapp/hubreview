      ...
      <Box display={"flex"} style={{flexWrap:"wrap"}}>
      {
        ...
        >
          <Group>
            ...
            <Text fw={500} size="lg" mt="md" >
              {check.conclusion.StringValue === "success" && <IconCircleCheck color="green" style={{ width: rem(22), height: rem(22), color: "green", marginLeft: 'auto' }} />}
              {check.conclusion.StringValue === "failure" && <IconXboxX color="red" style={{ width: rem(22), height: rem(22), color: "red", marginLeft: 'auto' }} />}
            </Text>

            <Anchor href="https://mantine.dev/" target="_blank" c={"blue"} style={{ position: "absolute", right: "15px", display: "flex" }}>
              Details
            </Anchor>
          </Group>
